...
<div align="center">
  <h1>ABHAY POTLE</h1>
  <p>
    <b>B.Tech in Computer Science & Engineering (Data Science) @ Vardhaman College of Engineering</b>
  </p>
  <p>
    <b>CGPA: 9.03 / 10.0 (Expected May 2027) | Hyderabad, India</b>
  </p>
...
### 🍿 Feature Showcases (Projects & Research)
...
<table width="100%">
  ...
  <tr>
    <td>
      <b>Category: Machine Learning Pipeline</b><br>
      <i>Logistic Regression, PCA, NLP Simulation</i>
      <hr>
      <ul>
        <li>Predicts placement probability with a customized <b>Logistic Regression</b> classifier.</li>
        <li>Integrates <b>PCA</b> for high-impact dimensionality reduction.</li>
        <li>Features built-in <b>NLP</b> scanning target job roles for skill fits.</li>
      </ul>
      <a href="https://github.com/AbhayPotle/STUDENT-PLACEMENT-PREDICTION"><b>💻 VIEW CODEBASE</b></a>
    </td>
    <td>
      <b>Category: Computer Vision / Edge AI</b><br>
      <i>TF.js, SSD MobileNet V1, BlazeFace, OCR</i>
      <hr>
      <ul>
        <li>Achieves <b>30+ FPS</b> real-time client-side face and body redaction.</li>
        <li>Runs entirely in-browser, ensuring <b>100% data privacy</b>.</li>
        <li>Integrates <b>Tesseract.js OCR</b> to scrub license plates and text.</li>
      </ul>
  ...
  <tr>
    <td>
      ...
      <hr>
      <ul>
        <li>Intelligent food discovery assistant recommending dining options.</li>
        <li>Integrates <b>Google Maps API</b> for real-time proximity mapping.</li>
        <li>Fully responsive glassmorphism client UI with curated filter parameters.</li>
      </ul>
    ...
    <td>
      ...
      <hr>
      <ul>
        <li>Cyberpunk game lobby hosting Chess, Carrom, and Typing games.</li>
        <li>Supports multi-client online matches via low-latency <b>WebSockets</b>.</li>
        <li>Enforces <b>JWT + bcrypt auth security</b> with guest session fail-safes.</li>
      </ul>
      <a href="https://github.com/AbhayPotle/ARCADE-GAMES"><b>💻 VIEW CODEBASE</b></a>
    </td>
    <td>
      <b>Category: Human-Computer Interaction</b><br>
      <i>MediaPipe Hands, CV, HTML5 Canvas</i>
      <hr>
      <ul>
        <li>Contactless gesture-controlled browser arcade game.</li>
        <li>Achieves <b>sub-50ms hand gesture latency</b> utilizing <b>MediaPipe</b>.</li>
        <li>Parallax graphics layer optimized for GPU acceleration.</li>
      </ul>
...
* **Programming Languages**: Python, SQL, JavaScript (ES6+), Java, C
* **Machine Learning & AI**: Scikit-Learn, TensorFlow, TensorFlow.js, OpenCV, MediaPipe, Natural Language Processing (NLP), Deep Learning, Neural Networks
...
* **AI & Machine Learning Internship** | *NIELIT Virtual Academy* (Govt. of India, 6 Weeks)
* **Power BI Professional Job Simulation** | *PwC Switzerland*
* **RIFT '26 Hackathon Finalist** | *Unstop Freedom Festival*
